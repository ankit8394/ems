          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="info_links">
              ...
              <div class="info_links_menu">
                <a target="_blank" href="index.php">Home <span class="sr-only">(current)</span></a>
                <a target="_blank" href="service.php">Services</a>
                <a target="_blank" href="about.php"> About</a>
                <a target="_blank" href="project.php">Project</a>
                <a target="_blank" href="testimonial.php">Testimonial</a>
                <a target="_blank" href="contact.php">Contact Us</a>
              </div>
            </div>
          </div>
